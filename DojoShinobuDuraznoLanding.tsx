...
addPropertyControls(DojoShinobuDuraznoLanding, {
    logoImage: { type: ControlType.Image, title: "Logo" },
    brand: { type: ControlType.String, title: "Marca", defaultValue: DEFAULTS.brand },
    discipline: {
    ...
    sensei: {
        type: ControlType.String,
        title: "Sensei",
        defaultValue: DEFAULTS.sensei,
    },
    rank: { type: ControlType.String, title: "Grado", defaultValue: DEFAULTS.rank },
    location: {
        type: ControlType.String,
        title: "Ubicacion",
    ...
    trustOneTitle: {
        type: ControlType.String,
        title: "Dato 1",
        defaultValue: DEFAULTS.trustOneTitle,
    },
    trustOneText: {
        type: ControlType.String,
        title: "Dato 1 Txt",
        defaultValue: DEFAULTS.trustOneText,
    },
    trustTwoTitle: {
        type: ControlType.String,
        title: "Dato 2",
        defaultValue: DEFAULTS.trustTwoTitle,
    },
    trustTwoText: {
        type: ControlType.String,
        title: "Dato 2 Txt",
        defaultValue: DEFAULTS.trustTwoText,
    },
    trustThreeTitle: {
        type: ControlType.String,
        title: "Dato 3",
        defaultValue: DEFAULTS.trustThreeTitle,
    },
    trustThreeText: {
        type: ControlType.String,
        title: "Dato 3 Txt",
        defaultValue: DEFAULTS.trustThreeText,
    },
    introLabel: {
        type: ControlType.String,
        title: "Intro Tag",
    ...
    flagTitle: {
        type: ControlType.String,
        title: "Bandera Tit.",
        defaultValue: DEFAULTS.flagTitle,
    },
    flagText: {
        type: ControlType.String,
        title: "Bandera Txt",
        defaultValue: DEFAULTS.flagText,
    },
    valuesLabel: {
        type: ControlType.String,
        title: "Valores Tag",
    ...
    senseiLabel: {
        type: ControlType.String,
        title: "Sensei Tag",
        defaultValue: DEFAULTS.senseiLabel,
    },
    senseiText: {
        type: ControlType.String,
        title: "Sensei Txt",
        defaultValue: DEFAULTS.senseiText,
        displayTextArea: true,
    },
    senseiCta: {
        type: ControlType.String,
        title: "Sensei CTA",
        defaultValue: DEFAULTS.senseiCta,
    },
    galleryLabel: {
        type: ControlType.String,
        title: "Galeria Tag",
    ...
    senseiImage: {
        type: ControlType.Image,
        title: "Sensei Img",
        defaultValue: DEFAULTS.senseiImage,
    },
    kidsImage: {
        type: ControlType.Image,
        title: "Ninos Img",
        defaultValue: DEFAULTS.kidsImage,
    },
    familyImage: {
        type: ControlType.Image,
        title: "Familia Img",
        defaultValue: DEFAULTS.familyImage,
    },
    flagImage: {
        type: ControlType.Image,
        title: "Bandera Img",
        defaultValue: DEFAULTS.flagImage,
    },
    backgroundColor: {
    ...
    surfaceColor: {
        type: ControlType.Color,
        title: "Seccion",
        defaultValue: DEFAULTS.surfaceColor,
    },
    textColor: {
        type: ControlType.Color,
        title: "Texto",
    ...
    mutedTextColor: {
        type: ControlType.Color,
        title: "Texto 2",
        defaultValue: DEFAULTS.mutedTextColor,
    },
    primaryColor: {
        type: ControlType.Color,
        title: "Primario",
